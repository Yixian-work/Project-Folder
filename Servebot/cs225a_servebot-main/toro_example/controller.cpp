...
int main() {
	...
	// q_init_desired(20) = M_PI / 6.0;
    q_init_desired(18) = M_PI/8.0;
	q_init_desired(20) = M_PI;
	q_init_desired(21) = M_PI/2.0;
	...
	while (runloop) {
		...
		// calculate torques 
		// command_torques = posori_task_torques_right_foot + posori_task_torques_left_foot + posori_task_torques_right_hand + posori_task_torques_left_hand + joint_task_torques;  // gravity compensation handled in sim
		command_torques = joint_task_torques; // Modified.
